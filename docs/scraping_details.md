...
The scraping process is implemented in [pipeline.py](file:///Users/pravintakpire/datascience/Competitions/Hackathons/Gemini_Hackathon/MarketWave/pipeline.py) and follows a four-step pipeline:
...
*   **Mechanics:** Reads [users.json](file:///Users/pravintakpire/datascience/Competitions/Hackathons/Gemini_Hackathon/MarketWave/users.json) to retrieve the watchlists of all registered users. It compiles them into a unique, sorted set of tickers.
...
*   **Storage**: Cleans whitespaces, runs sentiment calculations, and appends the processed data to [articles.csv](file:///Users/pravintakpire/datascience/Competitions/Hackathons/Gemini_Hackathon/MarketWave/articles.csv).
