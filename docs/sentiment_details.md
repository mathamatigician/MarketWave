...
*   **Source Logic:** `analyze_sentiment_gemini()` in [pipeline.py](file:///Users/mathamatigician/datascience/Competitions/Hackathons/Gemini_Hackathon/MarketWave/pipeline.py)
...
*   **Source Logic:** `aggregate_sentiment(sentiments)` in [functions.py](file:///Users/mathamatigician/datascience/Competitions/Hackathons/Gemini_Hackathon/MarketWave/functions.py)
...
*   **Source Logic:** `transform_sentiment(df)` in [functions.py](file:///Users/mathamatigician/datascience/Competitions/Hackathons/Gemini_Hackathon/MarketWave/functions.py)
